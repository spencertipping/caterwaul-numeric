...
// Vector functions.
// These are fairly standard vector functions. I've left some out because they really should be part of the matrix library; examples of this are things like the cross-product operator, which is
// just a matrix determinant.
         ...
         high_level_v_functions_for(base) = capture [unit = ref_compile(base, 'a'.qs,    'scale(a, 1 / norm(a))'.qs),
